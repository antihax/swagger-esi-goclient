...
func (c *APIClient) prepareRequest (
	...
	fileName string,
	fileBytes []byte,
	localVarHttpContentType string) (*http.Request, error) {
...
func (c *APIClient) setBody(body interface{}, contentType string) (*bytes.Buffer, error) {
	var (
		err       error
		bodyBytes []byte
	...
	} else if xmlCheck.MatchString(contentType) && (kind == reflect.Struct) {
